...
(function () {
  ...
  function boot() {
    ...
    var FRAG = [
      ...
      '  float pr = exp(-length(vec2(dx, dy) - uPointer) / 200.0) * uHeat;',
      '  col += vec3(0.50, 0.76, 0.95) * dotv * (0.06 + 0.30 * band + 0.62 * pr);',
