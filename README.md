...
| Шрифт Geist: кириллица и латиница (пробелы, цифры, знаки) предзагружаются вместе — пока приходила только кириллица, строка объявления на компьютере на миг становилась выше и страница сдвигалась | `src/layout.html` |
